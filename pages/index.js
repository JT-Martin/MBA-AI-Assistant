...
export default function Home() {
  ...
  }, [completion, userHasScrolled]); // Trigger when completion state changes or user scroll status changes

  const handleScroll = (e) => {
    // Check if user scrolled up
    const isUserScrollUp =
      e.target.scrollTop < e.target.scrollHeight - e.target.offsetHeight;
    setUserHasScrolled(isUserScrollUp);
  };
  ...
  function ExplainerVideoButton() {
    return (
      <a
        id="explainer-video-button"
        className={`${styles.button} ${styles.explainerVideoButton}`}
        target="_blank"
        href="https://learn.mbatraining.com.au/products/0342156b-44f7-4b3b-921e-824608b58d2e/categories/6f9bfd7c-bc14-4c9f-bc4b-fa8bf4ad0181/posts/494c8b2b-1e68-47ee-bf33-2e763304f36e"
      >
  ...
  function CheatsheetButton() {
    return (
      <a
        id="cheatsheet-button"
        className={`${styles.button} ${styles.cheatsheetButton}`}
        target="_blank"
        href="https://docs.google.com/document/d/1PrMT_zrB6UF8v_2CzW8f_sVkKUlaltBD9-tl6enDO38/edit?usp=sharing"
      >
        Ai Cheatsheet
      </a>
    );
  ...
  function RecipeButton(props) {
    return (
      <button
        className={`${styles.button} ${styles.recipeButton}`}
        onClick={() => {
        ...
        <div className={styles.grid}>
          <form className={styles.input}>
            <div>
              <h3>Human</h3>
              <h4>
                Input a detailed question, request or recipe and the Ai
                Assistant will respond to help.
              </h4>
          ...
          <div className={styles.output}>
            <div>
              <h3>Ai Assistant</h3>
              <h4>
                Copy & Paste the response. Use it to enhance your ideas or ask
                it to make new versions.
              </h4>
